...
<body>
	...
	<h4>Número de coches seleccionados: <%=datos.size()%></h4>
	<br>
	<table>
	<tr bgcolor= "#556B2F">
    ...
    <td><strong>Número de puertas</strong></td>
	...
	<br>
	<br>
	<a style='color:blue' href='./index.html'>Volver a la página de inicio</a>
	<br>
	<br>
		...
		<footer>
			<section>
				<div class="menu_footer1">
					<a href="Privacidad.html">Política de Privacidad</a> &nbsp|&nbsp <a href="Cookies.html">Cookies</a> &nbsp|&nbsp <a href="MapaDelSitio.html">Mapa del sitio</a>
				</div>
